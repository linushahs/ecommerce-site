...
function Dashboard() {
  ...
  //   useEffect(() => {
  //     if (isLogged) {
  //       fetchAllProducts(dispatch).then((res) => {
  //         console.log(res);
  //       });
  //     }
        ...
        <div className="cta-primary">
          <div className="cta-container">
            <div className="cta-details">
              ...
              <p>
                Get noticed by customers worldwide. Lorem ipsum dolor sit amet,
                consectetur adipiscing elit. Suspendisse in erat fermentum ante
                dignissim efficitur in sit amet urna. Praesent pretium erat sem,
                quis hendrerit mi mattis nec.
              </p>
            </div>
            <p className="cta-btn">
              <p>
                <Link href="/create_product">List Product</Link>
              </p>
              <svg
                    ...
                    <Link to={`/view_product/${items._id}`}>
                      ...
                      <div className="card-header">
                        ...
                        <div className="info">
                          ...
                          <span className="date">
                            {items.updatedAt.split("").slice(0, 10).join("")}
                          </span>
                        </div>
                      </div>
